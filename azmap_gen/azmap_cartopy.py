...
def createmap(locator):
    ...
    ax = plt.axes(projection=ccrs.AzimuthalEquidistant(central_longitude=lon_0, central_latitude=lat_0, false_easting=0.0, false_northing=0.0, globe=None))
    ...
    for az in range(10, 361, 10):
        ...
        plt.plot([lont, lon2], [latt, lat2], color='red', linewidth=0.25, transform=ccrs.Geodetic())
